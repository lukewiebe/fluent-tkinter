...
**Test suite:** 1837 tests across three categories:
...
src/fluent_tkinter/
  ...
  _patch.py         # Core monkey-patching logic (patches 55+ tkinter/ttk classes)
tests/
...
- `patch()` is idempotent and patches 32 tkinter + 23 ttk classes
